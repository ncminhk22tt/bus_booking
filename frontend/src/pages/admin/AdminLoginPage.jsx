...
export function AdminLoginPage() {
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-card">
      <h1 className="font-display text-3xl text-slate-900">Đăng nhập Admin</h1>
      <p className="mt-2 text-sm text-slate-600">Dùng tài khoản admin trong bảng admins để test các chức năng quản trị.</p>
